...
if replace_ensemble:
    plt.savefig("./plots/ensemble_features_importance_scores.svg", format='svg')
else:
    plt.savefig("./plots/all_features_importance_scores.svg", format='svg')
